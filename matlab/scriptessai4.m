...
% example with divergence free kernels for large deformations

clear

y = [[.25;0;0],[-.25;-.25;0],[-.25;0;0]];
target{1}.y = y;
...
x = [x,[y(1:2,:)+randn(2,size(y,2))/5;zeros(1,size(y,2))]]%[-.25;0;0],[.25;0;0],[0;.25;0]];
Nx = Nx + 3;
%x = x+1;
s.x = x;
...
switch useCpp
    case 1
        s.useDef = 'LargeDef';%input('taper 1 pour utiliser les Grandes Déformations, 2 pour les petites: ');
